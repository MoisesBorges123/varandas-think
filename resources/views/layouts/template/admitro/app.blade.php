...
<head>
    ...
    <title>{{ config('app.name', 'Varandas Bar') }} - {{ $title ?? 'Dashboard' }}</title>
...
<body class="theme-cyan">
    ...
    <!-- Top Navigation -->
    @include('layouts.template.admitro.partials.navbar')

    <!-- Left Sidebar -->
    @include('layouts.template.admitro.partials.sidebar')
    ...
    <script src="{{ asset('template/admitro/assets/bundles/mainscripts.bundle.js') }}"></script>
