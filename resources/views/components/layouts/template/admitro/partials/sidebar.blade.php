<aside class="app-sidebar">
    ...
    <ul class="side-menu app-sidebar3">
        ...
        <li class="slide">
            <a class="side-menu__item {{ request()->is('painel') ? 'active' : '' }}" href="{{ url('/painel') }}" wire:navigate>
        ...
        <li class="slide {{ request()->is('cardapio/*') ? 'is-expanded' : '' }}">
            ...
            <ul class="slide-menu">
                <li><a href="{{ route('cardapio.categorias.index') }}" wire:navigate class="slide-item {{ request()->routeIs('cardapio.categorias.*') ? 'active' : '' }}">Categorias</a></li>
                <li><a href="{{ route('cardapio.produtos.index') }}" wire:navigate class="slide-item {{ request()->routeIs('cardapio.produtos.*') ? 'active' : '' }}">Produtos</a></li>
            </ul>
        </li>
