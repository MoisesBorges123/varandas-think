...
{
    /**
     * Conexão usada pelos métodos desta trait. O Varandas usa a conexão
     * padrão do Laravel (MySQL/MariaDB) — ajuste aqui se o Repository
     * concreto precisar de uma conexão nomeada diferente.
     */
